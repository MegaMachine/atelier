      ...
      <div class="col-xl-4 col-lg-4 col-md-12">
        <div class="model-view__info">
          ...
          <div class="model-view__info__desc">
            ...
            <p>Підкладка: <span v-if="model.lining === true">З підклаткую</span><span v-if="model.lining === false">Без підклатки</span></p>
  ...
  export default {
    ...
    methods:{
      getChoiceCloth(event){
        ...
        let findMaterial =  _.find(cloths, {id_material: this.modelOptions.id_cloth})
